<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/xifen523/codex-overleaf-link/actions/workflows/test.yml"><img src="https://github.com/xifen523/codex-overleaf-link/actions/workflows/test.yml/badge.svg" alt="tests"></a>
...
One command installs the managed native host **and** managed extension runtime. On macOS/Linux it also creates the visible `~/Codex Overleaf Link Extension` shortcut pointing to the managed extension, copies that path to your clipboard, and opens `chrome://extensions` for you. Fork releases are installed manually from the pinned GitHub tag; the upstream signed auto-update channel is not used by this fork.

macOS / Linux:

```bash
CODEX_OVERLEAF_REF=v2.1.0 bash -c "$(curl -fsSL https://raw.githubusercontent.com/xifen523/codex-overleaf-link/v2.1.0/install.sh)"
```

Windows PowerShell:

```powershell
iwr https://raw.githubusercontent.com/xifen523/codex-overleaf-link/v2.1.0/install.ps1 -OutFile install.ps1
$env:CODEX_OVERLEAF_REF='v2.1.0'
...
The fork does not publish the upstream npm package name. `npm exec` can install the same managed native host and extension runtime directly from the pinned GitHub Release tarball.

```bash
npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- install-managed
```

Windows PowerShell:

```powershell
npm.cmd exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- install-managed
```
...
```bash
git clone https://github.com/xifen523/codex-overleaf-link.git
...
| Action | Command |
|--------|---------|
| Install / update | `npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- install-managed` |
| Diagnose | `npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- doctor` |
| Uninstall | `npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- uninstall-managed` |
...
The upstream managed updater only trusts signed releases from the original repository. For this fork, rerun the pinned GitHub installer when a new fork release is published. Re-run `install-managed` only for recovery or migration, including when the panel reports **Native host update required**. Explicitly unmanaged installations still require a manual extension/native update. After recovery, reload the extension in `chrome://extensions` and refresh Overleaf.

## GitHub Release Artifacts

The v2.1.0 GitHub Release contains:

- `codex-overleaf-link-extension-v2.1.0.zip`: loadable Chrome extension package for manual unpacked installation.
- `codex-overleaf-native-host-v2.1.0.tar.gz`: native host runtime files used by the installer and release verification.
- `codex-overleaf-link-2.1.0.tgz`: npm native host CLI package for pinned install, doctor, and uninstall flows.
- `install.sh`: release-pinned macOS / Linux installer that defaults to `v2.1.0` when run directly from the release artifact.
- `install.ps1`: release-pinned Windows PowerShell installer that defaults to `v2.1.0` when run directly from the release artifact.
...
```bash
npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- uninstall-managed
```
...
```bash
CODEX_OVERLEAF_REF=v2.1.0 bash -c "$(curl -fsSL https://raw.githubusercontent.com/xifen523/codex-overleaf-link/v2.1.0/install.sh)" -- --browser chromium
```

Linux Chromium uninstall:

```bash
npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- uninstall-managed --browser chromium
```
...
| Installer/update command | `npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- install-managed` | `npm.cmd exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- install-managed` | `npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- install-managed` | `npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- install-managed --browser chromium` |
| Uninstall command | `npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- uninstall-managed` | `npm.cmd exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- uninstall-managed` | `npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- uninstall-managed` | `npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- uninstall-managed --browser chromium` |
...
```bash
npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- install-native
```

Legacy native-only installations can be removed with:

```bash
npm exec --yes --package=https://github.com/xifen523/codex-overleaf-link/releases/download/v2.1.0/codex-overleaf-link-2.1.0.tgz codex-overleaf-link -- uninstall-native
```
