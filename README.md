...
```bash
CODEX_OVERLEAF_REF=v1.9.5 bash -c "$(curl -fsSL https://raw.githubusercontent.com/Ghqqqq/codex-overleaf-link/v1.9.5/install.sh)"
```

Windows PowerShell:

```powershell
iwr https://raw.githubusercontent.com/Ghqqqq/codex-overleaf-link/v1.9.5/install.ps1 -OutFile install.ps1
$env:CODEX_OVERLEAF_REF='v1.9.5'
...
```bash
npm exec --yes codex-overleaf-link@1.9.5 -- install-managed
```
...
| Action | Command |
|--------|---------|
| Install / update | `npm exec --yes codex-overleaf-link@1.9.5 -- install-managed` |
| Diagnose | `npm exec --yes codex-overleaf-link@1.9.5 -- doctor` |
| Uninstall | `npm exec --yes codex-overleaf-link@1.9.5 -- uninstall-managed` |
...
The v1.9.5 GitHub Release contains:

- `codex-overleaf-link-extension-v1.9.5.zip`: loadable Chrome extension package for manual unpacked installation.
- `codex-overleaf-native-host-v1.9.5.tar.gz`: native host runtime files used by the installer and release verification.
- `codex-overleaf-link-1.9.5.tgz`: npm native host CLI package for pinned install, doctor, and uninstall flows.
- `install.sh`: release-pinned macOS / Linux installer that defaults to `v1.9.5` when run directly from the release artifact.
- `install.ps1`: release-pinned Windows PowerShell installer that defaults to `v1.9.5` when run directly from the release artifact.
...
```bash
npm exec --yes codex-overleaf-link@1.9.5 -- uninstall-managed
```
...
```bash
CODEX_OVERLEAF_REF=v1.9.5 bash -c "$(curl -fsSL https://raw.githubusercontent.com/Ghqqqq/codex-overleaf-link/v1.9.5/install.sh)" -- --browser chromium
```

Linux Chromium uninstall:

```bash
npm exec --yes codex-overleaf-link@1.9.5 -- uninstall-managed --browser chromium
```
...
| Installer/update command | `npm exec --yes codex-overleaf-link@1.9.5 -- install-managed` | `npm exec --yes codex-overleaf-link@1.9.5 -- install-managed` | `npm exec --yes codex-overleaf-link@1.9.5 -- install-managed` | `npm exec --yes codex-overleaf-link@1.9.5 -- install-managed --browser chromium` |
| Uninstall command | `npm exec --yes codex-overleaf-link@1.9.5 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@1.9.5 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@1.9.5 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@1.9.5 -- uninstall-managed --browser chromium` |
...
```bash
npm exec --yes codex-overleaf-link@1.9.5 -- install-native
```

Legacy native-only installations can be removed with:

```bash
npm exec --yes codex-overleaf-link@1.9.5 -- uninstall-native
```
