...
```bash
CODEX_OVERLEAF_REF=v2.1.0 bash -c "$(curl -fsSL https://raw.githubusercontent.com/Ghqqqq/codex-overleaf-link/v2.1.0/install.sh)"
```

Windows PowerShell:

```powershell
iwr https://raw.githubusercontent.com/Ghqqqq/codex-overleaf-link/v2.1.0/install.ps1 -OutFile install.ps1
...
```bash
npm exec --yes codex-overleaf-link@2.1.0 -- install-managed
```
...
| Action | Command |
|--------|---------|
| Install / update | `npm exec --yes codex-overleaf-link@2.1.0 -- install-managed` |
| Diagnose | `npm exec --yes codex-overleaf-link@2.1.0 -- doctor` |
| Uninstall | `npm exec --yes codex-overleaf-link@2.1.0 -- uninstall-managed` |
...
```bash
npm exec --yes codex-overleaf-link@2.1.0 -- uninstall-managed
```
...
```bash
CODEX_OVERLEAF_REF=v2.1.0 bash -c "$(curl -fsSL https://raw.githubusercontent.com/Ghqqqq/codex-overleaf-link/v2.1.0/install.sh)" -- --browser chromium
```

Linux Chromium uninstall:

```bash
npm exec --yes codex-overleaf-link@2.1.0 -- uninstall-managed --browser chromium
```
...
| Installer/update command | `npm exec --yes codex-overleaf-link@2.1.0 -- install-managed` | `npm exec --yes codex-overleaf-link@2.1.0 -- install-managed` | `npm exec --yes codex-overleaf-link@2.1.0 -- install-managed` | `npm exec --yes codex-overleaf-link@2.1.0 -- install-managed --browser chromium` |
| Uninstall command | `npm exec --yes codex-overleaf-link@2.1.0 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@2.1.0 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@2.1.0 -- uninstall-managed` | `npm exec --yes codex-overleaf-link@2.1.0 -- uninstall-managed --browser chromium` |
...
```bash
npm exec --yes codex-overleaf-link@2.1.0 -- install-native
```

Legacy native-only installations can be removed with:

```bash
npm exec --yes codex-overleaf-link@2.1.0 -- uninstall-native
```
