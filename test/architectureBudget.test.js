...
test('architecture budget tracks v1.0 final split targets for the largest files', async () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      ['extension/src/content/contentRuntime.js', 8750],
      ['extension/src/content/panelMaintenance.js', 300],
      ['extension/src/content/markdownText.js', 700],
      ['extension/src/content/diagnosticsController.js', 700],
      ['extension/src/content/runTimelineView.js', 1080],
      ...
      ['extension/src/content/writebackOrchestrator.js', 820],
