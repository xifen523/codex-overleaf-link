(function initCodexOverleafI18n(root, factory) {
  ...
  const MESSAGES = {
    en: {
      ...
      runAcceptTrackedNeedsReview: 'Accept changes — needs review',
      runAcceptTrackedNeedsReviewTitle: 'This run\'s tracked changes may not be fully accepted; inspect Overleaf and retry.',
      runUndoNeedsReview: 'Undo — needs review',
      runUndoNeedsReviewTitle: 'This run\'s undo may not be fully verified; inspect Overleaf and retry.',
