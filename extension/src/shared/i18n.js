(function initCodexOverleafI18n(root, factory) {
  ...
  const MESSAGES = {
    en: {
      ...
      experimentalOtMenuSubtitle: 'Experimental — speeds up reading the file you are editing; Codex falls back to normal reading whenever unsure.',
      ...
      tasks: 'Tasks',
      placeholder: 'Ask Codex anything. Click ＋ to add context',
      mode: 'Mode',
      ...
      contextStatus: 'Click ＋ to add context: files, attachments (PDF/images), @compile-log, @current-section.',
      ...
      emptyRunsHint: 'Click ＋ to add files, type / for commands.',
    ...
    zh: {
      ...
      experimentalOtMenuSubtitle: '实验性——加快读取你正在编辑的文件；拿不准时自动回退到普通读取。',
      ...
      newSession: '新建会话',
      tasks: '任务',
      placeholder: '问 Codex 任何事。点 ＋ 添加上下文',
      mode: '模式',
      writeMode: '写入模式',
      modeAsk: '只问不改',
      ...
      contextStatus: '点 ＋ 添加上下文：文件、附件（PDF/图片）、@compile-log、@current-section。',
