(function initCodexOverleafI18n(root, factory) {
  ...
  const MESSAGES = {
    en: {
      ...
      runAcceptTrackedFailed: 'Accept all could not be completed',
      runAcceptTrackedFailedReason: 'Overleaf editor content has drifted from this run\'s writeback, so Codex did not change the document. The run stays pending — retry Accept all.',
    ...
    zh: {
      ...
      runAcceptTrackedFailed: '没有完成接受全部改动',
      runAcceptTrackedFailedReason: 'Overleaf 编辑器内容已经和本轮写入不一致，Codex 没有改动文档。本轮仍为待处理状态——请重新点击接受全部改动。',
      detailAccepted: '已接受',
