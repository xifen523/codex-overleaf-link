(function initCodexOverleafI18n(root, factory) {
  ...
  const MESSAGES = {
    en: {
      ...
      customInstructionsSavedToast: 'Custom instructions saved for this project.',
    ...
    zh: {
      ...
      customInstructionsSavedToast: '已保存当前项目的自定义指令。',
