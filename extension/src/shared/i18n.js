(function initCodexOverleafI18n(root, factory) {
  ...
  const MESSAGES = {
    en: {
      ...
      runAcceptTracked: 'Accept all changes',
      runAcceptTrackedRetry: 'Accept remaining changes',
      runAcceptTrackedTitle: 'Accept this run\'s Overleaf tracked changes',
      runAcceptTrackedRetryTitle: 'Accept the tracked changes from this run that are not settled yet',
      ...
      runAcceptTrackedResolvedElsewhere: 'Resolved in Overleaf',
      runAcceptTrackedResolvedElsewhereTitle: 'This run\'s tracked changes were already resolved in Overleaf',
    ...
    zh: {
      ...
      runAcceptTracked: '接受全部改动',
      runAcceptTrackedRetry: '接受剩余改动',
      runAcceptTrackedTitle: '接受本轮 Overleaf 留痕改动',
      runAcceptTrackedRetryTitle: '接受本轮尚未处理的留痕改动',
      ...
      runAcceptTrackedResolvedElsewhere: '已在 Overleaf 处理',
      runAcceptTrackedResolvedElsewhereTitle: '本轮留痕改动已在 Overleaf 中处理',
